...
import { footerMenuList1, footerMenuList2,
     footerMenuList3, footerMenuList4 } from '../../common/Constants';
                ...
                <Row className="footerMenuWrap">
                    <Col xs={6} md={3}>
                        <Nav className="footerMenuList">
                            {footerMenuList1 && footerMenuList1.map(Obj => (
                    ...
                    <Col xs={6} md={3}>
                        <Nav className="footerMenuList">
                            {footerMenuList2 && footerMenuList2.map(Obj => (
                                <NavItem key={Obj.id} href="#">
                                    {Obj.value}
                                </NavItem>
))}
                    ...
                    <Col xs={6} md={3}>
                        <Nav className="footerMenuList">
                            {footerMenuList3 && footerMenuList3.map(Obj => (
                                <NavItem key={Obj.id} href="#">
                                    {Obj.value}
                                </NavItem>
))}
                    ...
                    <Col xs={6} md={3}>
                        <Nav className="footerMenuList">
                            {footerMenuList4 && footerMenuList4.map(Obj => (
                                <NavItem key={Obj.id} href="#">
                                    {Obj.value}
                                </NavItem>
))}
